...
export function QuickActions({ onAdd, onAskAI }: QuickActionsProps) {
  ...
  return (
    <div className="layout-cards grid-cols-2">
      <button
        onClick={onAdd}
        className="group relative flex flex-col items-center justify-center gap-3 surface-primary hover:bg-zinc-50 dark:hover:bg-zinc-900/50 hover:shadow-md active:scale-[0.98] overflow-hidden"
      >
